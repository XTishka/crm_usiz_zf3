...
class DebtToPlantController extends AbstractActionController {
    ...
    /**
     * DebtToPlantController constructor.
     * @param DebtToPlantService $service
     */
    public function __construct(DebtToPlantService $service) {
