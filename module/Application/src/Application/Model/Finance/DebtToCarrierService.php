...
/**
 * Сервис получает записи задолженностей перед перевозчиками
 * Class DebtToCarrierService
 * @package Application\Model\Finance
 */
class DebtToCarrierService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new DebtToCarrierContainer($data);
    }
