...
/**
 * Сервис получает записи предоплат от покупателей
 * Class PrepayFromCustomerService
 * @package Application\Model\Finance
 */
class PrepayFromCustomerService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new PrepayFromCustomerContainer($data);
    }
    ...
    public function getContractorRecords($companyId) {
        ...
        $select->where->in('tsn.contractor_type', [ContractorCustomer::TYPE_CUSTOMER]);
