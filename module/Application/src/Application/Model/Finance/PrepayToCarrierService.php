...
/**
 * Сервис получает записи предоплат перевозчикам
 * Class PrepayToCarrierService
 * @package Application\Model\Finance
 */
class PrepayToCarrierService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new PrepayToCarrierContainer($data);
    }
