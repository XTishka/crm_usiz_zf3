...
/**
 * Сервис получает записи задолженностей перед заводами
 * Class DebtToPlantService
 * @package Application\Model\Finance
 */
class DebtToPlantService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new DebtToPlantContainer($data);
    }
    ...
    public function getContractorRecords($companyId) {
        ...
        $select->where->in('tsn.contractor_type', [ContractorCustomer::TYPE_PLANT]);
