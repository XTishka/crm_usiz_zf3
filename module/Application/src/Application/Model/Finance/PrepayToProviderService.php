...
/**
 * Сервис получает записи предоплат поставщикам
 * Class PrepayToProviderService
 * @package Application\Model\Finance
 */
class PrepayToProviderService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new PrepayToProviderContainer($data);
    }
