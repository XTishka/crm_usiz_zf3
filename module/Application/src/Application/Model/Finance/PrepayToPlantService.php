...
/**
 * Сервис получает записи предоплат заводам
 * Class PrepayToPlantService
 * @package Application\Model\Finance
 */
class PrepayToPlantService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new PrepayToPlantContainer($data);
    }
    ...
    public function getContractorRecords($companyId) {
        ...
        $select->where->equalTo('tsn.contractor_type', ContractorCustomer::TYPE_PLANT);
