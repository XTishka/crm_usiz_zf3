...
/**
 * Сервис получает записи задолженностей перед поставщиками
 * Class DebtToProviderService
 * @package Application\Model\Finance
 */
class DebtToProviderService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new DebtToProviderContainer($data);
    }
    ...
    public function getContractorRecords($companyId) {
        ...
        $select->where->in('tsn.contractor_type', [ContractorCustomer::TYPE_PROVIDER]);
