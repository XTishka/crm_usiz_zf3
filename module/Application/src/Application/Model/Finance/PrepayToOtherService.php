...
/**
 * Сервис получает записи предоплат прочих контрагентов
 * Class PrepayToOtherService
 * @package Application\Model\Finance
 */
class PrepayToOtherService extends AbstractService {
    ...
    public function getRecords($companyId): ContainerInterface {
        ...
        return new PrepayToOtherContainer($data);
    }
