...
class PurchaseWagonDbFactory implements FactoryInterface {
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) {
        ...
        $hydrator = new Hydrator\ClassMethods();//$container->get('HydratorManager')->get(Hydrator\ClassMethods::class);
        ...
        $hydrator->addStrategy('transport_contractor_id', new IntegerStrategy());
        ...
        $prototype = new Domain\PurchaseWagonEntity();

        return clone new PurchaseWagonDb($dbAdapter, $hydrator, $prototype);
    }
